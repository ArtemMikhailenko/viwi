...
function PasswordInput({ password, setPassword, label = 'Пароль', autoComplete = 'new-password', error, ...inputParams }) {
    const inputId = useId()
    ...
    return (
        <div>
            <label className="block text-[#2D215A] text-base leading-6 font-normal select-none" htmlFor={inputId}>
                {label}
            </label>
            <div className={twMerge(
                'form-input',
                'flex flex-row w-full !h-[48px] p-0 !bg-transparent !border-[#D6D6ED] !rounded-[12px]',
            )}>
                <input
                    id={inputId}
                    className="flex grow h-full bg-transparent border-transparent focus:border-transparent focus:ring-0 font-normal text-base"
                ...
                />
                <div
                    className="w-min h-min p-3 cursor-pointer"
                    ...
                    {visible ? (
                        <svg width="22" height="22" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
                            <path
                                ...
                                opacity="0.24"
                                d="M11 2.97925C3.66665 2.97925 1.14581 9.16675 1.14581 11.0001C1.14581 12.8334 3.66665 19.0209 11 19.0209C18.3333 19.0209 20.8541 12.8334 20.8541 11.0001C20.8541 9.16675 18.3333 2.97925 11 2.97925Z"
                                fill="#2D215A"
                            />
                            <path
                                className="fill-current text-gray-400 dark:text-gray-500"
                        ...
                        <svg width="22" height="22" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
                            <path
                                className="fill-current text-gray-400 dark:text-gray-500"
                                opacity="0.24"
                                d="M1.83331 11C1.83331 13.2917 4.58331 18.3334 11 18.3334C13.3723 18.3334 15.2434 17.6442 16.6597 16.6597L5.34027 5.34033C2.92579 7.01873 1.83331 9.55562 1.83331 11Z"
                                fill="#2D215A"
                            />
                            <path
                                className="fill-current text-gray-400 dark:text-gray-500"
